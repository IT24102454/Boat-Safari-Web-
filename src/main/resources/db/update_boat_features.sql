...
UPDATE boat
SET features = 'Premium Seating,Navigation System,Bimini Top,Cooler Storage,Bottled Water,Fishing Gear,Bluetooth Speakers'
WHERE model LIKE '%Safari 270%' OR boat_name LIKE '%Safari 270%';
